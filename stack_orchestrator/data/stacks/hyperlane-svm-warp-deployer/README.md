...
Clones the gorbagana `hyperlane-monorepo` fork at `v2.2.0-gorbagana.3` (in lockstep with the hyperlane-svm-deployer image it reuses) to `~/cerc/hyperlane-monorepo`.
