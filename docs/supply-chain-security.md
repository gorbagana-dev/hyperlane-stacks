...
- The `Cargo.lock` file from the gorbagana `hyperlane-monorepo` fork at `v2.2.0-gorbagana.2` is committed and used as-is
...
```json
{
  "hyperlane_deployer_source": "gorbagana-dev/hyperlane-monorepo@v2.2.0-gorbagana.2",
