...
- The `Cargo.lock` file from the gorbagana Hyperlane fork at `v2.2.0-gorbagana.4` is committed and used as-is
...
```json
{
  "hyperlane_deployer_source": "gorbagana-dev/hyperlane-monorepo@v2.2.0-gorbagana.4",
